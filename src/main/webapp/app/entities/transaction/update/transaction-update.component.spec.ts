...
describe('Transaction Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 13214 };
      transaction.user = user;

      const userCollection: IUser[] = [{ id: 20049 }];
    ...
    it('Should call Client query and add missing value', () => {
      const transaction: ITransaction = { id: 456 };
      const client: IClient = { id: 30184 };
      transaction.client = client;

      const clientCollection: IClient[] = [{ id: 21334 }];
    ...
    it('Should update editForm', () => {
      const transaction: ITransaction = { id: 456 };
      const user: IUser = { id: 28688 };
      transaction.user = user;
      const client: IClient = { id: 6919 };
      transaction.client = client;
