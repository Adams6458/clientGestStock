...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.m2i.gatwaypaiement.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.m2i.gatwaypaiement.security.DomainUserDetailsService", "createSpringSecurityUser");
